...
class Ui_LogWindow(object):
    def setupUi(self, LogWindow):
        ...
        LogWindow.resize(400, 712)
        LogWindow.setMinimumSize(QSize(400, 560))
        self.styleSheet = QWidget(LogWindow)
...
"")
        ...
        self.row_4.setMinimumSize(QSize(200, 200))
        ...
        self.Log_Box = QPlainTextEdit(self.row_4)
        self.Log_Box.setObjectName(u"Log_Box")
        sizePolicy3 = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
        sizePolicy3.setHorizontalStretch(0)
        sizePolicy3.setVerticalStretch(0)
        sizePolicy3.setHeightForWidth(self.Log_Box.sizePolicy().hasHeightForWidth())
        self.Log_Box.setSizePolicy(sizePolicy3)
        self.Log_Box.setMinimumSize(QSize(0, 0))
        self.Log_Box.setStyleSheet(u"background-color: rgb(33, 37, 43);")
        self.Log_Box.setInputMethodHints(Qt.ImhMultiLine)
        self.Log_Box.setReadOnly(True)
        self.Log_Box.setMaximumBlockCount(300)

        self.verticalLayout_21.addWidget(self.Log_Box)
        ...
        LogWindow.setCentralWidget(self.styleSheet)
    ...
    def retranslateUi(self, LogWindow):
        ...
        self.titleRightInfo.setText(QCoreApplication.translate("LogWindow", u"Log Viewer", None))
#if QT_CONFIG(tooltip)
        self.minimizeAppBtn.setToolTip(QCoreApplication.translate("LogWindow", u"Minimize", None))
#endif // QT_CONFIG(tooltip)
        self.minimizeAppBtn.setText("")
#if QT_CONFIG(tooltip)
        self.maximizeRestoreAppBtn.setToolTip(QCoreApplication.translate("LogWindow", u"Maximize", None))
#endif // QT_CONFIG(tooltip)
        self.maximizeRestoreAppBtn.setText("")
#if QT_CONFIG(tooltip)
        self.closeAppBtn.setToolTip(QCoreApplication.translate("LogWindow", u"Close", None))
#endif // QT_CONFIG(tooltip)
